...
' eines GET-Requests. Analog zu Tennis26/VmixTcpSender.vb - IP/Port kommen hier aus
' Fussballuhr.IP/Fussballuhr.TcpPort (Settings-TextBox43) statt aus Tennis26_Settings.
...
Public Class VmixTcpSender
    ...
    ' oder wenn sich die IP in den Settings geändert hat.
    Private Sub EnsureConnected()
        ...
        client.Connect(Fussballuhr.IP, Fussballuhr.TcpPort)
    ...
    ' Grund nicht beantwortet, das Spiel nicht blockiert.
